...
Gui, Add, Text, x20 y15 w410 h35 +Center c0x00FFC8, MLG21 BIOME MACRO V1.1
...
TestWebhook:
    ...
    if (WebhookURL = "" || InStr(WebhookURL, "discord.com/api/webhooks/") == 0) {
        MsgBox, 16, Error, Please input Webhook URL before testing!
        return
    }
      ...
      "embeds": [
        {
          ...
          "color": 16711680,
          "fields": [
            {"name": "Total Uptime (Treo được)", "value": "%totalTimeRan%", "inline": false},
